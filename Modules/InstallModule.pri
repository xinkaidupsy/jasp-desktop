...
isEmpty(MODULE_NAME) {
	...
	unix{ ################## Unix ##################
		...
		GenerateLanguageFiles$${MODULE_NAME}.commands += ; echo using Rscript:  $$_R_HOME/bin/Rscript ;
		GenerateLanguageFiles$${MODULE_NAME}.commands +=  $$_R_HOME/bin/Rscript $$PWD/../Tools/translate.R $$PWD/$${MODULE_NAME} ;
	}#Unix
	}#########################################################
