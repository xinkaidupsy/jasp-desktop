...
Form
{
	...
	VariablesForm
	{
		...
		enabled:								!useSummaryStatistics.checked & (performanceMateriality.checked | minimumPrecision.checked)
	...
	Section
	{
		...
		enabled:								performanceMateriality.checked | minimumPrecision.checked
		columns: 								1
