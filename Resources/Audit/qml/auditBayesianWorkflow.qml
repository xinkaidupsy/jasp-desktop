...
Form
{
	...
	Section
	{
		...
		VariablesForm
		{
			...
			enabled:		 						!pasteVariables.checked & (performanceMateriality.checked | minimumPrecision.checked)
			...
			AssignedVariablesList
			{
				...
				title: 								performanceMateriality.checked & materialityAbsolute.checked ? qsTr("Ist Values <i>(required)</i>") : qsTr("Ist Values <i>(optional)</i>")
				singleVariable: 					true
		...
		Section
		{
			...
			enabled:								(performanceMateriality.checked | minimumPrecision.checked) & recordNumberVariable.count > 0
			columns: 								1
		...
		Section
		{
			...
			GroupBox
			{
				...
				CheckBox
				{
					...
					name: 							"decisionPlot"
					enabled:						!separateKnownAndUnknownMisstatement.checked & ![2, 3].includes(priorConstructionMethod.currentIndex)
				}
		...
		Section
		{
			...
			GroupBox
			{
				...
				CheckBox
				{
					...
					CheckBox
					{
						text: 						qsTr("Show correlation between Ist and Soll")
						name:						"correlationPlotShowCorrelation"
					}

					CheckBox
					{
						text: 						qsTr("Show transaction ID's")
